                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="{{url('/categories/create')}}">Create Categories</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapsePages2" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{url('/brands')}}">All Brands</a>
                            <a class="nav-link" href="{{url('/brands/create')}}">Create Brands</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapsePages3" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{url('/sliders')}}">All Sliders</a>
                            <a class="nav-link" href="{{url('/sliders/create')}}">Create Sliders</a>
                        </nav>
                    </div>
